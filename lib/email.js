...
const mailer = {
    inboxGmailRegist: (email, codeverify) => {
        ...
        <div
            ...
            <h3>Welcome to DluxTzy - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283890284607">WhatsApp</a></span></span>
      ...
      `;
          ...
          let mailOptions = {
              from: '"DluxTzy-Api" <no-reply@gmail.com>',
              to: email,
              subject: `Verify Email - DluxTzy-Api`,
              html: inboxGmail,
          };
